...
const shellBracketTextLinkOnDarkClass = `${bracket} rounded-mm-xs outline-none transition-colors hover:text-mm-neutral-0 ${focusRing} focus-visible:outline-mm-neutral-0 focus-visible:outline-solid`
...
const shellBracketBrandLinkOnDarkClass = `${bracket} outline-none ${focusRing} focus-visible:outline-mm-neutral-0 focus-visible:outline-solid`
