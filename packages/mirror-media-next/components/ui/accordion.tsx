  ...
  return (
    <AccordionPrimitive.Header className="flex">
      <AccordionPrimitive.Trigger
        className={cn(
          'group/accordion-trigger relative flex flex-1 items-start justify-between rounded-mm-m border border-transparent py-mm-l text-left font-mm-sans text-mm-body2 font-medium text-mm-all-black transition-colors outline-none hover:text-mm-base-700 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-mm-all-black focus-visible:outline-solid aria-disabled:pointer-events-none aria-disabled:opacity-50',
          className
        )}
